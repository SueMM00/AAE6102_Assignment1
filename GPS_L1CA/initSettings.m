...
settings.fileName           = 'C:\Users\User\Sue\Documents\PhD\study\semesters\2024 sem 2\AAE6102\raw\Urban.dat';
...
% Intermediate, sampling and code frequencies Opensky
%settings.IF                 = -1580e6+1575.42e6;     % [Hz]
%settings.samplingFreq       = 58e6;        % [Hz]

% Intermediate, sampling and code frequencies Urban
settings.IF                 = 0;     % [Hz]
